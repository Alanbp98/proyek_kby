									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											...
											<a class="menu-link" href="">
												...
												<span class="menu-title">Daftar Donasi</span>
											</a>
											<a class="menu-link" href="">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
						...
						<div class="topbar d-flex align-items-stretch">
							...
							<div class="d-flex align-items-center me-2 me-lg-4">
								<a href="../bantuan.php" target="_blank" class="btn btn-icon btn-borderless btn-active-primary bg-white bg-opacity-10" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Bantuan">
									...
									<span class="svg-icon svg-icon-1 svg-icon-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						...
						<div id="kt_content_container" class="container-xxl">
								...
								<div class="card-body">
									<div class="row gy-5 g-xl-8">
										...
										<div class="col-xl-4">
											...
											<div class="input-group  mb-5"><input type="text" class="form-control"></div>
										</div>
										<div class="col-xl-4">
							...
							<div class="card mb-5 mb-xl-10 shadow-sm" id="kt_profile_details_view">
								...
								<div class="card-header cursor-pointer">
									...
									<a href="#" class="btn btn-primary align-self-center btn-hover-scale me-5" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah</a>
									<!--end::Action-->
								</div>
								<!--begin::Card header-->
								<!--begin::Card body-->
								<div class="card-body p-9">
									...
									<div class="row g-6 g-xl-9 mb-6 mb-xl-9">
										...
										<div class="table-responsive">
											...
											<table class="table table-hover table-rounded table-striped border gy-7 gs-7 cssTable">
												<thead>
												...
												<tbody>
													<tr>
														<td>L001</td>
														<td>PK-I</td>
														<td>Perawat Klinis I</td>


														<td><span class="badge badge-success">Aktif</span></td>
														<td>
															<a href="#" class="btn btn-icon btn-warning btn-hover-scale me-5" data-bs-toggle="modal" data-bs-target="#modalUbah"><i class="bi bi-pencil-square"></i></a>
														</td>
										...
										<div class="row">
											<div class="col-sm-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start">
												<div class="dataTables_length">
													<label>
														<select class="form-control form-control-sm text-dark font-weight-bold mr-4 border-0 bg-light-dark" style="width: 75px;">
						...
						<div class="modal-dialog modal-fullscreen">
							<div class="modal-content shadow-none">
								<div class="modal-header">
									...
									<!--begin::Close-->
									<div class="btn btn-icon btn-sm btn-active-light-danger ms-2 btn-hover-scale me-5" data-bs-dismiss="modal" aria-label="Close">
								...
								<div class="modal-body">
									...
									<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
										...
										<div class="d-flex flex-stack flex-grow-1">
											...
											<div class="fw-bold">
												...
												<div class="fs-6 text-gray-700">Kolom pengisian dengan tanda bintang *) berwarna merah adalah wajib diisi.
												</div>
											</div>
											<!--end::Content-->
										</div>
									...
									<label for="basic-url" class="form-label">Level <span class="text-danger">*</span></label>
									<div class="input-group mb-5">
										<input type="text" class="form-control">
									</div>

									<label for="basic-url" class="form-label">Keterangan <span class="text-danger">*</span></label>
									<div class="input-group mb-5">
										<input type="text" class="form-control">
									</div>
									...
									<label for="basic-url" class="form-label">Status <span class="text-danger">*</span></label>
									<div class="input-group  mb-5">

										<div class="input-group  mb-5">
											<div class="form-check form-check-custom form-check-solid">

												<input class="form-check-input" type="radio" name="status" checked="checked" value="advanced" />
												<label class="form-check-label" for="flexRadioDefault"> Aktif
												</label>
											</div>
										</div>
										<div class="input-group  mb-5">
											<div class="form-check form-check-custom form-check-solid">
												...
												<input class="form-check-input" type="radio" name="status" checked="checked" value="advanced" />
												<label class="form-check-label" for="flexRadioDefault"> Tidak Aktif
												</label>
											</div>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-light btn-hover-scale me-5" data-bs-dismiss="modal">Tutup</button>
									<button type="button" id="sa_tambah" class="btn btn-danger btn-hover-scale me-5">Simpan</button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-dialog modal-fullscreen">
							<div class="modal-content shadow-none">
								...
								<div class="modal-body">
									...
									<label for="basic-url" class="form-label">Kode</label>
									<div class="input-group mb-5">
										<input type="text" class="form-control" disabled placeholder="L001">
									</div>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-light btn-hover-scale me-5" data-bs-dismiss="modal">Tutup</button>
									<button type="button" id="sa_ubah" class="btn btn-danger btn-hover-scale me-5">Simpan</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
							<div class="text-dark-50 font-size-lg font-weight-bolder" style="margin: 0 auto;">
								<span class="mr-1"><strong>&#169;2023</strong></span> Kita Bantu Yuk,
								<a href="" target="_blank" class="text-dark-75 text-hover-primary">kby.com</a>
							</div>
						</div>
